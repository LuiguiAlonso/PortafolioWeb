    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
      ...
      <div className="container mx-auto px-6 text-center z-10">
        ...
        <p className="text-xl text-slate-400 max-w-2xl mx-auto mb-10 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          Creando experiencias digitales en <span className="text-cyan-400">Web</span>, <span className="text-purple-400">Móvil</span> y <span className="text-green-400">Videojuegos</span>.
        </p>
